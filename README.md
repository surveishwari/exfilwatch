...
**[Live demo](https://exfilwatch.onrender.com)** · **[GitHub](https://github.com/surveishwari/exfilwatch)** · [Quick start](#quick-start-verified) · [Demo flow](#2-minute-demo-flow) · [Architecture](#architecture) · [Self red-team](#we-attacked-our-own-detector-live) · [API](#api--one-line-integration)
...
```bash
git clone https://github.com/surveishwari/exfilwatch.git && cd exfilwatch
